...
class CircularBuffer<T> : Iterable<T>, Cloneable {
     ...
     */
    constructor(circularBuffer: CircularBuffer<T>) {
        this.arr = circularBuffer.arr.copyOf()
    ...
    public override fun clone(): CircularBuffer<T> = CircularBuffer(this)
